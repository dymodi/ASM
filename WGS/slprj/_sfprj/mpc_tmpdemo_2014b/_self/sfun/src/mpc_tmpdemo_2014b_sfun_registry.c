...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_mpc_tmpdemo_2014b_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_mpclib_process_check_sum_call( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_mpc_tmpdemo_2014b_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "mpc_tmpdemo_2014b") == 0) {
    sf_mpc_tmpdemo_2014b_uses_exported_functions(nlhs, plhs, nrhs-2, prhs+2);
    return 1;
  }
...
unsigned int sf_process_autoinheritance_call( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_mpc_tmpdemo_2014b_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "mpc_tmpdemo_2014b") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_mpc_tmpdemo_2014b_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_third_party_uses_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_mpc_tmpdemo_2014b_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "mpc_tmpdemo_2014b") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_mpc_tmpdemo_2014b_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_jit_fallback_info_call( int nlhs, mxArray * plhs[],
  int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_mpc_tmpdemo_2014b_jit_fallback_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "mpc_tmpdemo_2014b") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_mpc_tmpdemo_2014b_jit_fallback_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_updateBuildInfo_args_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_mpc_tmpdemo_2014b_updateBuildInfo_args_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "mpc_tmpdemo_2014b") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_mpc_tmpdemo_2014b_updateBuildInfo_args_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_mpc_tmpdemo_2014b_get_eml_resolved_functions_info( int
  ...
  if (strcmp(machineName, "mpc_tmpdemo_2014b") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_mpc_tmpdemo_2014b_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
...
unsigned int sf_process_get_post_codegen_info(int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[])
{
  extern void sf_mpc_tmpdemo_2014b_get_post_codegen_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  ...
  machineName[(sizeof(machineName)/sizeof(char)-1)] = '\0';
  if (strcmp(machineName, "mpc_tmpdemo_2014b") == 0) {
    sf_mpc_tmpdemo_2014b_get_post_codegen_info(nlhs, plhs, nrhs-2, prhs+2);
    return 1;
  }
...
extern unsigned int sf_mpc_tmpdemo_2014b_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"mpc_tmpdemo_2014b")) {
    return(sf_mpc_tmpdemo_2014b_method_dispatcher(simstructPtr,chartFileNumber,
...
extern void mpc_tmpdemo_2014b_terminator(void);
...
extern void mpc_tmpdemo_2014b_initializer(void);
extern void mpclib_initializer(void);
extern void mpc_tmpdemo_2014b_register_exported_symbols(SimStruct* S);
extern void mpclib_register_exported_symbols(SimStruct* S);
extern void mpc_tmpdemo_2014b_debug_initialize(struct SfDebugInstanceStruct*);
extern void mpclib_debug_initialize(struct SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  mpc_tmpdemo_2014b_register_exported_symbols(S);
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      mpc_tmpdemo_2014b_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    mpc_tmpdemo_2014b_initializer();
    if (!simModeIsRTWGen) {
