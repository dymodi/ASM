% A Naive Dual Active Set Method
...
% Also note, this dual ASM never pass tests.

function [xStar, zStar, iterStar, finalAS, failFlag] = asm_dual_naive(H,invH,oric,oriA,b,x,w,maxIter)
